...
const List<Map<String, dynamic>> localImageData = [
  ...
  {
    'imageUrl': "${path}ilustration15.jpg",
    'name': 'Golden Gate Bridge',
    'favorite': false,
    'author': 'Lucas Green',
    'source': 'Unsplash',
    'description':
        'The iconic Golden Gate Bridge shrouded in fog, creating a mystical and captivating scene.',
    'date': '2024-04-10',
    'location': 'San Francisco, USA',
    'camera': 'Sony A7R III',
  },
  {
    'imageUrl': "${path}ilustration16.jpg",
    'name': 'Autumn Leaves',
    'favorite': true,
    'author': 'Mia Clark',
    'source': 'Pexels',
    'description':
        'A forest floor covered in vibrant autumn leaves, showcasing the beauty of the fall season.',
    'date': '2024-05-05',
    'location': 'Vermont, USA',
    'camera': 'Canon EOS 80D',
  },
  {
    'imageUrl': "${path}ilustration17.jpg",
    'name': 'Starry Night',
    'favorite': true,
    'author': 'Ethan Lewis',
    'source': 'Pixabay',
    'description':
        'A clear night sky filled with countless stars, creating a mesmerizing and awe-inspiring view.',
    'date': '2024-06-20',
    'location': 'Atacama Desert, Chile',
    'camera': 'Nikon D7500',
  },
  {
    'imageUrl': "${path}ilustration18.jpg",
    'name': 'Cherry Blossoms',
    'favorite': false,
    'author': 'Ava Martinez',
    'source': 'Unsplash',
    'description':
        'A beautiful display of cherry blossoms in full bloom, signaling the arrival of spring.',
    'date': '2024-07-15',
